...
# Load the Excel file
        file_path = fname #"C:\\Learnings\\SaiSamridh\\html\\outsrc.xlsx" # Replace with the actual file path0"
...
# Load the Excel file
        file_path = fname #"C:\\Users\\saijo\\OneDrive\\Desktop\\Learnings\\SaiSamridh\\html\\outsrc.xlsx" # Replace with the actual file path0"
        #file_path = "outsrc.csv" # Replace with the actual file path0"
...
def name_phone_check():
        name = input("Enter your name: ")
        phone = input("Enter your phone number: ")
        if name and phone:
                print(f"Hello, {name}! Your phone number is {phone}.")
        else:
                print("You didn't enter a name or phone number.")

def name_phone_email_check():
        name = input("Enter your name: ")
        phone = input("Enter your phone number: ")
        email = input("Enter your email address: ")
        if name and phone and email:
                print(f"Hello, {name}! Your phone number is {phone} and your email address is {email}.")
        else:
                print("You didn't enter a name, phone number, or email address.")

def name_phone_file_append_check():
        name = input("Enter your name: ")
        phone = input("Enter your phone number: ")
        email = input("Enter your email address: ")
        if name and phone and email:
...
def name_phone_file_append(fname):
        name = input("Enter your name: ")
        phone = input("Enter your phone number: ")
        #email = input("Enter your email address: ")
...
def name_phone_file_append2(fname):
        ...
        while True:
                ...
                if name and phone:
                        ...
                        print("You didn't enter a name, phone number.")
                        break
        csvfile.close()    
...
if __name__ == "__main__":
        ...
        print(fname, "****\n")
        Read_csv_file(fname)
        #Read_csv_file("outsrc.csv")
        Read_csv_file("extracted_data.csv")
        Read_csv_file_all("phones.csv")
        Read_csv_file("phones.csv")
        name_phone_file_append2("phones.csv")
        Read_csv_file("phones.csv")
        json_to_python_dict()
        func_var()
        func_builtinDT()
